...
export type CellLayers = components["schemas"]["CellLayers"];
export type PlannedCellLayer = components["schemas"]["PlannedCellLayer"];
export type Stratum = components["schemas"]["Stratum"];
export type CultivationMode = components["schemas"]["CultivationMode"];
...
export type Variety = components["schemas"]["VarietyResponse"];
