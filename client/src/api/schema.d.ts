...
export interface components {
  schemas: {
    ...
    /**
     * @description All layers in a grid cell plus its blocked status.
     *     A cell may host up to one plant per stratum layer simultaneously.
     */
    CellLayers: {
      /** @description `true` when the cell is a non-plantable zone (path, alley, obstacle). */
      blocked: boolean;
      /** @description Occupied stratum layers (empty when the cell is free and not blocked). */
      layers: components["schemas"]["PlannedCellLayer"][];
    };
    CompanionInfo: {
      id: string;
      name: string;
    ...
    /**
     * @description One way to cultivate a variety: its spacing, and the height stratum it occupies.
    ...
    CultivationMode: {
      ...
      /**
       * Format: int32
       * @description Maximum plant height in centimetres for this cultivation mode.
       */
      maxHeightCm: number;
      /**
       * Format: int32
       * @description Minimum plant height in centimetres for this cultivation mode.
       */
      minHeightCm: number;
      name: string;
      /**
       * Format: int32
       * @description Centre-to-centre spacing in centimetres.
       */
      spacingCm: number;
    ...
    /** @description One stratum layer within a cell, carrying the plant data for that layer. */
    PlannedCellLayer: {
      cell: components["schemas"]["PlannedCell"];
      cultivationModeId: string;
      cultivationModeName: string;
      stratumId: string;
      stratumName: string;
    };
    /** @description A single preference entry with an optional desired plant count. */
    PreferenceEntry: {
      /** @description Optional cultivation mode id. When absent the variety's default mode is used. */
      cultivationModeId?: string | null;
      id: string;
      /**
       * Format: int32
    ...
    /** @description The height layer a plant occupies in the garden. */
    Stratum: {
      id: string;
      name: string;
    };
    ...
    VarietyResponse: {
      ...
      cultivationModes: components["schemas"]["CultivationMode"][];
      /** Format: int32 */
    ...
    WeeklyPlan: {
      ...
      grid: components["schemas"]["CellLayers"][][];
