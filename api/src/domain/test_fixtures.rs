...
use crate::domain::models::variety::{
    CalendarWindow, Category, CultivationMode, Lifecycle, Region, RegionCalendar, SoilType,
    Stratum, SunExposure, Variety,
};
use crate::domain::models::vegetable::Vegetable;

/// Builds a single-mode intermediate cultivation mode for test fixtures.
fn intermediate_mode(variety_id: &str, spacing_cm: u32) -> CultivationMode {
    CultivationMode {
...
/// Builds a single-mode ground-cover cultivation mode for test fixtures.
fn ground_cover_mode(variety_id: &str, spacing_cm: u32) -> CultivationMode {
    CultivationMode {
        id: format!("{variety_id}-standard"),
        name: "Standard".into(),
        spacing_cm,
...
/// Builds a single-mode canopy cultivation mode for test fixtures.
fn canopy_mode(variety_id: &str, spacing_cm: u32) -> CultivationMode {
    CultivationMode {
        id: format!("{variety_id}-standard"),
        name: "Standard".into(),
        spacing_cm,
...
pub fn get_all_varieties() -> Vec<Variety> {
    vec![
        Variety {
            ...
            cultivation_modes: vec![intermediate_mode("tomato", 60)],
            days_to_harvest: 75,
            days_to_plant: 42,
        ...
        Variety {
            ...
            cultivation_modes: vec![canopy_mode("zucchini", 90)],
            days_to_harvest: 55,
            days_to_plant: 21,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            cultivation_modes: vec![ground_cover_mode("carrot", 10)],
            days_to_harvest: 75,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![ground_cover_mode("basil", 20)],
            days_to_harvest: 30,
            days_to_plant: 21,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            soil_types: vec![SoilType::Loamy, SoilType::Humus, SoilType::Clay],
            cultivation_modes: vec![ground_cover_mode("lettuce", 30)],
            days_to_harvest: 45,
            days_to_plant: 21,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Sandy, SoilType::Loamy],
            cultivation_modes: vec![ground_cover_mode("radish", 5)],
            days_to_harvest: 25,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            cultivation_modes: vec![ground_cover_mode("onion", 10)],
            days_to_harvest: 100,
            days_to_plant: 60,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Sandy],
            cultivation_modes: vec![ground_cover_mode("garlic", 10)],
            days_to_harvest: 240,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            cultivation_modes: vec![intermediate_mode("leek", 15)],
            days_to_harvest: 120,
            days_to_plant: 60,
        ...
        Variety {
            ...
            cultivation_modes: vec![intermediate_mode("green-bean", 15)],
            days_to_harvest: 55,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![canopy_mode("cucumber", 60)],
            days_to_harvest: 55,
            days_to_plant: 21,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![intermediate_mode("pepper", 50)],
            days_to_harvest: 70,
            days_to_plant: 60,
            lifecycle: Lifecycle::Annual,
        ...
        Variety {
            ...
            cultivation_modes: vec![intermediate_mode("pea", 10)],
            days_to_harvest: 60,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Clay, SoilType::Chalky],
            cultivation_modes: vec![intermediate_mode("cabbage", 50)],
            days_to_harvest: 90,
            days_to_plant: 35,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Clay, SoilType::Chalky],
            cultivation_modes: vec![intermediate_mode("broccoli", 50)],
            days_to_harvest: 80,
            days_to_plant: 35,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![ground_cover_mode("parsley", 20)],
            days_to_harvest: 75,
            days_to_plant: 21,
            lifecycle: Lifecycle::Biennial,
            beginner_friendly: true,
        ...
        Variety {
            ...
            cultivation_modes: vec![ground_cover_mode("thyme", 30)],
            days_to_harvest: 90,
            days_to_plant: 28,
        ...
        Variety {
            ...
            cultivation_modes: vec![intermediate_mode("rosemary", 40)],
            days_to_harvest: 90,
            days_to_plant: 28,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: true,
        ...
        Variety {
            ...
            cultivation_modes: vec![ground_cover_mode("beet", 15)],
            days_to_harvest: 60,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::PartialShade, SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus, SoilType::Clay],
            cultivation_modes: vec![ground_cover_mode("spinach", 15)],
            days_to_harvest: 40,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Sandy],
            cultivation_modes: vec![canopy_mode("fennel", 30)],
            days_to_harvest: 90,
            days_to_plant: 21,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![intermediate_mode("eggplant", 60)],
            days_to_harvest: 75,
            days_to_plant: 60,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Loamy, SoilType::Humus, SoilType::Clay],
            cultivation_modes: vec![intermediate_mode("celery", 30)],
            days_to_harvest: 100,
            days_to_plant: 60,
            lifecycle: Lifecycle::Biennial,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Sandy, SoilType::Humus],
            cultivation_modes: vec![intermediate_mode("potato", 35)],
            days_to_harvest: 90,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus, SoilType::Clay],
            cultivation_modes: vec![canopy_mode("maïs", 40)],
            days_to_harvest: 80,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![canopy_mode("pumpkin", 120)],
            days_to_harvest: 100,
            days_to_plant: 21,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![ground_cover_mode("chive", 20)],
            days_to_harvest: 60,
            days_to_plant: 21,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::PartialShade, SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus, SoilType::Clay],
            cultivation_modes: vec![ground_cover_mode("mint", 30)],
            days_to_harvest: 60,
            days_to_plant: 0,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Loamy, SoilType::Sandy, SoilType::Humus],
            cultivation_modes: vec![ground_cover_mode("strawberry", 30)],
            days_to_harvest: 90,
            days_to_plant: 30,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun, SunExposure::PartialShade],
            soil_types: vec![SoilType::Loamy, SoilType::Clay, SoilType::Chalky],
            cultivation_modes: vec![ground_cover_mode("turnip", 20)],
            days_to_harvest: 40,
            days_to_plant: 0,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: true,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Clay, SoilType::Chalky],
            cultivation_modes: vec![intermediate_mode("cauliflower", 60)],
            days_to_harvest: 80,
            days_to_plant: 35,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![intermediate_mode("red-pepper", 50)],
            days_to_harvest: 70,
            days_to_plant: 60,
            lifecycle: Lifecycle::Annual,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Sandy, SoilType::Loamy],
            cultivation_modes: vec![canopy_mode("asparagus", 45)],
            days_to_harvest: 730,
            days_to_plant: 90,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: false,
        ...
        Variety {
            ...
            sun_requirement: vec![SunExposure::FullSun],
            soil_types: vec![SoilType::Loamy, SoilType::Humus],
            cultivation_modes: vec![canopy_mode("artichoke", 80)],
            days_to_harvest: 365,
            days_to_plant: 60,
            lifecycle: Lifecycle::Perennial,
            beginner_friendly: false,
...
pub fn get_all_vegetables() -> Vec<Vegetable> {
    vec![
        ...
        Vegetable {
            id: "basil".into(),
            name: "Basil".into(),
            group_id: "legumes-feuilles".into(),
            color: "#1A5C38FF".into(),
...
pub fn get_group_by_id(id: &str) -> Option<Group> {
    get_all_groups().into_iter().find(|g| g.id == id)
}
...
pub fn get_all_groups() -> Vec<Group> {
    vec![
        ...
        Group {
            id: "engrais-verts".into(),
            name: "Green Manure".into(),
        },
        Group {
            id: "legumes-feuilles".into(),
            name: "Leafy Vegetables".into(),
        },
        Group {
            id: "legumes-fruits".into(),
            name: "Fruiting Vegetables".into(),
        },
        Group {
            id: "legumes-racines".into(),
            name: "Root Vegetables".into(),
        },
        Group {
            id: "plantes-a-grains".into(),
            name: "Grain Plants".into(),
        },
    ]
}
